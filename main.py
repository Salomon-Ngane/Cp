...
from bot.handlers.creation import (
...
async def global_callback_router(update: Update, context):
    ...
    # IMPORTANT :
    # Un seul query.answer() ici. Les handlers ne doivent pas répondre
    # deux fois au même callback.
    try:
        await query.answer()
    except Exception:
        pass
    ...
    if data == "menu_account":
        ...
        # menu_duel, menu_tickets, menu_live, type_*, sport_*,
        # ticket_*, etc. sont traités par creation.py.
